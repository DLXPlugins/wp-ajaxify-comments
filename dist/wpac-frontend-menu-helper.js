  ...
  var launchSelectorHelper = function launchSelectorHelper() {
    sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire({
      ...
      didOpen: function didOpen() {
        ...
        var commentListSelectors = ['.wp-block-comment-template', '#comments', '.comments-wrapper', '.ast-comment-list', '.comments', '.comment-list', '.comment-area'];
        ...
        commentListSelectors.forEach(function (commentSelector) {
