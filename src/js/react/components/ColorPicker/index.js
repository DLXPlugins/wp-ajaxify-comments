...
const ColorPickerControl = ( props ) => {
	...
	return (
		<BaseControl className="ajaxify-block-component-color-picker-wrapper">
			{ ( !! label && ! hideLabelFromVision ) && (
				<h3 className="ajaxify-block-color-component-label">
					<span>{ label }</span>
				</h3>
			) }
			<div className="ajaxify-block-component-color-picker">
				<div className="ajaxify-block-color-picker-area ajaxify-block-component-color-picker-palette">
					{ ! isVisible && (
						<>
							<div
					...
					{ isVisible && (
						...
						>
							...
							<BaseControl className="ajaxify-block-component-color-picker-palette">
								<ColorPalette
