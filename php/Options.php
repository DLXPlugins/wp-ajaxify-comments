...
class Options {
	...
	private static function get_default_label_values() {
		return array(
			...
			'textReloadPage'               => array( 'Reloading page. Please wait.', 'Reloading page. Please wait&hellip;' ),
			'textPostComment'              => array( 'Posting your comment. Please wait.', 'Posting your comment. Please wait&hellip;' ),
			'textRefreshComments'          => array( 'Loading comments. Please wait.', 'Loading comments. Please wait&hellip;' ),
