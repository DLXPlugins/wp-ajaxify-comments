...
class Menu_Helper {
	...
	public function before_ajaxify_load() {
		...
		if ( $ajaxify_enabled ) {
			...
			if ( ! wp_verify_nonce( $nonce, 'wpac_disable_ajaxify_' . get_the_ID() ) ) {
				return;
			}
		}
