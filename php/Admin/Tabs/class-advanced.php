...
class Advanced {
	...
	public function __construct() {
		...
		add_filter( 'comment_edit_pro_output_advanced', array( $this, 'output_main_content' ), 1, 3 );
	}
	...
	public function add_main_tab( $tabs ) {
		$tabs[] = array(
			'get'    => 'advanced',
			'action' => 'comment_edit_pro_output_advanced',
			'url'    => Functions::get_settings_url( 'advanced' ),
			'label'  => _x( 'Advanced', 'Tab label as Advanced', 'ultimate-auto-updates' ),
			'icon'   => 'flask',
		);
		return $tabs;
	}
