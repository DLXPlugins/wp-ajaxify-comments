		...
		<header id="ajaxify-admin-header">
			<div id="ajaxify-admin-header-content">
				...
				<div class="ajaxify-admin-header-links">
					...
					<a href="<?php echo esc_url_raw( $support_url ); ?>" target="_blank" class="ajaxify-admin-link" rel="noopener noreferrer"><?php esc_html_e( 'Support', 'wp-ajaxify-comments' ); ?></a>
				</div>
			</div>
		</header>
		<?php
